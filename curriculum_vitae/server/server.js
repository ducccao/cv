...
// build
const build_direction = express.static(path.join(__dirname, "../build"));
// middle ware

// cors
// https://caovanducs.herokuapp.com/
// http://localhost:3000
app.use(function (req, res, next) {
  res.header("Access-Control-Allow-Origin", "https://caovanducs.herokuapp.com/"); // update to match the domain you will make the request from
  res.header(
